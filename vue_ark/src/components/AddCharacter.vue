        ...
        <div class="border">
          <el-form :model="form0" label-width="80px" class="pad">
            <div class="flex1">
              <el-form-item label="代号">
                <el-input v-model="form0.id"></el-input>
              </el-form-item>
              <el-form-item label="英文代号">
                <el-input v-model="form0.eng"></el-input>
              </el-form-item>
            </div>
            <div class="flex1">
              ...
              <el-form-item label="二级职业">
                <el-select v-model="form0.ico_2" @change="selectIcoDe">
            ...
            <div class="flex1">
              <el-form-item label="标签">
                ...
                <el-checkbox-group v-model="form0.tag">
          ...
          <el-form :model="form0" label-width="140px" class="pad">
            <div class="border1 slice_width">
              ...
              <div v-for="(item, i) in form0.tianfu" :key="i">
              ...
              <div v-for="(item, i) in form0.skill_f" :key="i">
                ...
                <div class="flex1">
                  ...
                  <el-form-item label="消耗技力">
                    <el-input v-model="item.use"></el-input>
                  </el-form-item>
                  <el-form-item label="持续时间">
                    <el-input v-model="item.usetime"></el-input>
                  </el-form-item>
                </div>
      ...
      <el-col id="right" :lg="12">
        ...
        <div class="border pad-bot">
              ...
              <div v-for="(item, i) in form0.skill_b" :key="i">
                ...
                <div class="flex1">
                  ...
                  <el-form-item label="技能图标">
                    <el-input v-model="item.ico"></el-input>
                  </el-form-item>
                </div>
                <el-form-item label="技能描述">
                  <el-input v-model="item.de"></el-input>
          ...
          <el-form ref="form" :model="form0" label-width="80px" class="pad">
            ...
            <div class="flex1">
              <el-form-item label="真实姓名">
                <el-input v-model="form0.real_name"></el-input>
              </el-form-item>
            ...
            <div class="flex1">
              <el-form-item type="textarea" label="特殊">
                <el-input v-model="form0.special"></el-input>
              </el-form-item>
            </div>
          </el-form>
          <el-form ref="form" :model="form0" label-width="140px" class="pad">
            ...
            <el-form-item label="备注">
                <el-input type="textarea" v-model="form0.sto_area"></el-input>
            </el-form-item>
            <div class="border1 slice_width">
          ...
          <el-form ref="form" :model="form0" label-width="170px" class="pad">
            ...
            <el-form-item label="体细胞与源石融合率" v-if="form0.sto<2">
              <el-input type="number" v-model="form0.act" class="wid_input1"></el-input>%
            </el-form-item>
            <el-form-item label="体细胞与源石融合描述" v-if="form0.sto<2">
              <el-input v-model="form0.act_de"></el-input>
            </el-form-item>
            <el-form-item label="血液源石结晶密度" v-if="form0.sto<2">
              <el-input v-model="form0.mi" class="wid_input1"></el-input>u/L
            </el-form-item>
            <el-form-item label="血液源石结晶密度影响" v-if="form0.sto<2">
              <el-input v-model="form0.mi_de"></el-input>
            </el-form-item>
            <el-form-item label="备注">
...
const form0 = reactive({
  ...
  sto_area: "",
  sto_note: "",
  test: { phy: 0, speed: 0, blood: 0, pla: 0, ski: 0, stone: 0 },
  obj: "",
  dang1: "",
  dang2: "",
  dang3: "",
...
const selectIcoDe = (itme) => {
  form0.ico_2 = professions_2.value[itme].profession_2;
  form0.feat = professions_2.value[itme].de;
  console.log(form0)
}
const selectStars = () => {
  var skill_num = 0;
  if (form0.stars < 3) {
    skill_num = 0;
  } else if (form0.stars < 4) {
    skill_num = 1;
  } else if (form0.stars < 6) {
    skill_num = 2;
  } else {
    skill_num = 3;
  }
  for (var i = form0.skill_f.length; i <= skill_num; i++) {
    const skill = { name: "", type1: "", type2: "", start: 0, use: 0, usetime: 0, de: "", note: "" };
    form0.skill_f.push(skill);
  }
  for (var i0 = form0.skill_f.length; i0 > skill_num; i0--) {
    form0.skill_f.pop();
  }
}
const addtianfu = () => {
  const unit = { name: "", de_zero: "", de_one: "", de_two: "", notes: "" };
  form0.tianfu.push(unit);
}
const minustianfu = () => {
  form0.tianfu.pop();
}
const addskill = () => {
  const unit = { name: "", de: "", need: "", pos: "", ico: "" };
  form0.skill_b.push(unit);
}
const minusskill = () => {
  form0.skill_b.pop();
}
const selectsto = () => {
  if (form0.sto==0) {
    form0.stu = "参照医学检测报告，确认为非感染者。";
    form0.dis = "造影检测结果显示，该干员体内脏器轮廓清晰，未见异常阴影，循环系统内源石颗粒检测未见异常，无矿石病感染迹象，现阶段可确认为非矿石病感染者。";
  } else if(form0.sto==1) {
    form0.stu = "体表有原石结晶分布，参照医学检测报告，确认为感染者。";
    form0.dis = "造影检测结果显示，该干员体内脏器轮廓模糊，可见异常阴影，循环系统内源石颗粒检测异常，有矿石病感染迹象，现阶段可确认为是矿石病感染者。";
  }else{
    form0.stu = "";
    form0.dis = "";
  }
...
const SubmitEvent = () => {
  console.log(form0.dang1)
  console.log(form0.dang2)
  console.log(form0.dang3)
  console.log(form0.dang4)
  console.log(form0.up)
  if (form0.se) {
    form0.sex = "女"
  } else {
    form0.sex = "男"
  ...
  if (form0.stars == 2) {
    form0.tag.push("新手")
  } else if (form0.stars == 5) {
    form0.tag.push("资深干员")
  } else if (form0.stars == 6) {
    form0.tag.push("高级资深干员")
  } else if (form0.stars == 1) {
    form0.tag.push("支援机械")
  }
  const itme_name = form0.ico + "干员";
  form0.tag.push(itme_name);
  form0.tag.push(form0.pos);
  proxy.$request
    .post(proxy.$urls.m().add_character, form0)
    .then((result) => {
      if (result.data == 200) {
        ElMessage({
          message: '保存成功',
